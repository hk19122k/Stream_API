...
public class Onepiece2 {
    public static void main(String[] args) {
        ...
        // ----------- this is how wwe compare and sort based on employee salary in
        // ascending irder --------------//
        ...
        // --------- real-world multi-level comparator — extremely important for
        // backend, dashboards, and data presentation----------------//
        ...
        // .thenComparing(Comparator.comparing(Movie::getRating).reversed())) //joining
        // 2 compartors to one and then sorting it
